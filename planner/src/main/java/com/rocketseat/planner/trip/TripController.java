...
import com.rocketseat.planner.activitiy.ActivityData;
import com.rocketseat.planner.activitiy.ActivityRequestPayload;
import com.rocketseat.planner.activitiy.ActivityResponse;
import com.rocketseat.planner.activitiy.ActivityService;
...
public class TripController {
    ...
    public ResponseEntity<TripCreateResponse> createTrip(@RequestBody TripRequestPayload payload) {
        ...
        return ok(new TripCreateResponse(newTrip.getId()));
    }
    ...
    public ResponseEntity<ParticipantCreateResponse> inviteParticipant(@PathVariable UUID id, @RequestBody ParticipantRequestPayload payload) {
        ...
        if (trip.isPresent()) {
            ...
            return ok(participantCreateResponse);
        }
